...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2024 at 06:03 AM
...
(8, 'pbkdf2_sha256$720000$0ug6cwcbeUd3W9ssxDvOVX$AXFF5mHob3HWfPoqMzWUlx3BG1AkAkcoPACKwFv2wUY=', '2024-08-01 03:37:08.375541', 1, 'Developtrees', '', '', 'reecha.arava@developtrees.com', 1, 1, '2024-07-23 11:45:45.084012'),
...
(1, 'images/card7.jpeg', 'What do you get?', 'Users will receive a minimum of 10% off on bus tickets.'),
...
(1, 'What is Teerdha Bus?', 'Teerdha Bus is an online ticketing platform that enables users to book bus tickets for various routes and operators across multiple countries.'),
(2, 'How do I book a bus ticket on Teerdha?', 'To book a bus ticket on Teerdha, visit their website or mobile app, enter your travel details (such as origin, destination, date of travel, and number of passengers), select from the available bus options, and complete the booking process by making a payment.'),
(3, 'Is it safe to book bus tickets on Teerdha?', 'Yes, Teerdha uses advanced security measures to protect users\' personal and payment information. Additionally, Teerdha partners with reputable bus operators to ensure safe and reliable travel.'),
(4, 'Can I cancel or modify a bus ticket booked on Teerdha?', 'Yes, you can cancel or modify your bus ticket booked on Teerdha, subject to the cancellation and modification policies of the respective bus operator. You can initiate cancellations or modifications through your Teerdha account or by contacting Teerdha customer support.'),
(5, 'How do I receive my bus ticket booking on Teerdha?', 'After booking a bus ticket on Teerdha, you will receive a confirmation email and/or SMS with your ticket details and a unique booking ID. You can either print the e-ticket or show the SMS/email confirmation to the bus operator at the time of boarding.'),
...
(7, 'Are there any discounts or offers available on Teerdha?', 'Teerdha frequently offers discounts, cashback, and promotional deals on bus bookings. You can check their website or mobile app for the latest offers.'),
...
(9, 'Can I track my bus in real time using Teerdha?', 'Yes, Teerdha offers real-time tracking for buses on select routes and with certain operators. You can track your bus using the \"Track My Bus\" feature on the Teerdha website or mobile app.'),
(10, 'What should I do if I face any issues during my journey booked through Teerdha?', 'If you encounter any issues during your journey, such as delays, cancellations, or other concerns, you can contact Teerdha customer support for assistance. They will help resolve the issue and ensure a smooth travel experience.');
...
(1, '', 'images/plan_your_next_trip_with_us.jpg', 'How can you obtain it?', 'Festival Offer: Save Up to Rs. 900.'),
...
(1, 'How do you get it ?', 'To avail of the discount, users must book bus tickets for their preferred destination by applying the coupon code displayed on the page.', ''),
(2, '', 'This offer is valid on bookings made from April 20th to April 31st, 2024.', ''),
...
(1, 'Ayodhya Travel Guide', '', 'Limited Time Offer', 'Apply the coupon code BUSWEEKENDS to save Rs. 500 on your booking.'),
(2, '', '', '', 'The offer is valid for one use per user during the offer period.\r\n\r\n\r\n\r\n'),
...
(1, 'images/teerdha.jpg', '', 'reecha.arava@developtrees.com', '9878987899', 8);
...
('aqupn0f609uufekvcvvl5w14lro60961', '.eJxVjMsOwiAQRf-FtSEUy2Ncuu83kIEZpGogKe3K-O_apAvd3nPOfYmA21rC1nkJM4mL8OL0u0VMD647oDvWW5Op1XWZo9wVedAup0b8vB7u30HBXr71GZizJ0Mja6UYso_WgvOgLCA40ETEmNA7M0QwrJiix2HMGpGBnHh_APpOOMI:1sZMcm:1vQw0J4U5AhEejtqbc3nzxt7jgFVgBvg9Rqv0UB5SFA', '2024-08-15 03:37:08.397339'),
